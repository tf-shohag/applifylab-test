// Helper function to get SVG icons for explore menu items
const getExploreIcon = (iconName) => {
    const icons = {
        'learning-icon': (
...
export default function LeftSidebar() {
    const exploreItems = [
        { name: 'Learning', icon: 'learning-icon', badge: 'New', href: '#0' },
        { name: 'Insights', icon: 'insights-icon', href: '#0' },
        { name: 'Find friends', icon: 'find-friends-icon', href: '/find-friends' },
        { name: 'Bookmarks', icon: 'bookmarks-icon', href: '#0' },
        { name: 'Group', icon: 'group-icon', href: '/group' },
        { name: 'Gaming', icon: 'gaming-icon', badge: 'New', href: '#0' },
        { name: 'Settings', icon: 'settings-icon', href: '#0' },
        { name: 'Save post', icon: 'save-icon', href: '#0' }
    ];
                        ...
                        <div key={index} className="_left_inner_area_suggest_info">
                            <div className="_left_inner_area_suggest_info_box">
                                <div className="_left_inner_area_suggest_info_image">
                                    <a href="/profile">
                                        <img src={person.image} alt="Image" className="_info_img" />
                                    </a>
                                </div>
            ...
            <div className="_layout_left_sidebar_inner">
                <div className="_left_inner_area_event _padd_t24 _padd_b6 _padd_r24 _padd_l24 _b_radious6 _feed_inner_area">
                    ...
                    {events.map((event, index) => (
                        <a key={index} className="_left_inner_event_card_link" href="/event-single">
                            <div className="_left_inner_event_card">
                                ...
                                <div className="_left_inner_event_bottom">
                                    ...
                                    <button type="button" onClick={(e) => e.stopPropagation()} className="_left_iner_event_bottom_link">Going</button>
                                </div>
                            </div>
                        </a>
                    ))}
